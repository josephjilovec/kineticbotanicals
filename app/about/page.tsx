...
export const metadata: Metadata = {
  title: "Why Kinetic",
  description: "Why Kinetic Aromatics is built for active spaces: compact format, close-to-skin aroma, and scent-first choice.",
};
      ...
      <section className="bg-[#f0ecfb]">
        <div className="mx-auto grid max-w-[1500px] gap-8 px-5 py-16 lg:grid-cols-[1fr_.9fr] lg:px-8 lg:py-24">
          <div className="self-center">
            ...
            <p className="mt-7 max-w-xl text-base leading-7 text-black/58">A gym is not a nightclub, a fragrance counter, or a spa. It is a shared, high-energy environment. Kinetic Aromatics is built around that context.</p>
          </div>
      ...
      <section className="section-shell">
        <div className="grid gap-4 lg:grid-cols-3">
          {[
            ...
            [Leaf, "Aromatic, not mystical", "The brand can feel alive and sensory without leaning on vague wellness promises. The product is about aroma, ritual, and portability."],
      ...
      <section className="section-shell pt-0">
        <div className="kinetic-grid rounded-[40px] bg-[#dff8f2] p-7 md:p-12">
          ...
          <div className="mt-4 grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
            <h2 className="text-[clamp(3.5rem,7vw,7.4rem)] font-black leading-[.82] tracking-[-.075em]">NOT COLOGNE.<br />NOT A SUPPLEMENT.<br /><span className="text-[#d85a2e]">A GYM-BAG AROMATIC.</span></h2>
            <div>
              <p className="text-base leading-7 text-black/60">That positioning gives Kinetic Aromatics a clear shelf in the customer’s mind: an active-lifestyle scent product made specifically for transitions around training.</p>
